...
old_modules = {
    'switch_model.balancing_areas',
    'switch_model.export',
    'switch_model.export.__init__',
    'switch_model.export.dump',
    'switch_model.export.example_export',
    'switch_model.financials',
    'switch_model.fuel_cost',
    'switch_model.fuel_markets',
    'switch_model.fuels',
    'switch_model.gen_tech',
    'switch_model.generators.hydro_simple',
    'switch_model.generators.hydro_system',
    'switch_model.generators.storage',
    'switch_model.hawaii.batteries',
    'switch_model.hawaii.batteries_fixed_calendar_life',
    'switch_model.hawaii.constant_elasticity_demand_system',
    ...
    'switch_model.load_zones',
    'switch_model.local_td',
    'switch_model.main',
    'switch_model.project.build',
    'switch_model.project.discrete_build',
    'switch_model.project.dispatch',
    'switch_model.project.no_commit',
    'switch_model.project.unitcommit.commit',
    'switch_model.project.unitcommit.discrete',
    'switch_model.project.unitcommit.fuel_use',
    'switch_model.solve',
    'switch_model.solve_scenarios',
    'switch_model.test',
    'switch_model.timescales',
    'switch_model.trans_build',
    'switch_model.trans_dispatch',
    'switch_model.utilities',
    'switch_model.project',
    'switch_model.project.unitcommit',
}
rename_modules = {
    'switch_model.load_zones': 'switch_model.balancing.load_zones',
    'switch_model.fuels': 'switch_model.energy_sources.properties',
    'switch_model.trans_build': 'switch_model.transmission.transport.build',
    'switch_model.trans_dispatch': 'switch_model.transmission.transport.dispatch',
    'switch_model.project.build': 'switch_model.generators.core.build',
    'switch_model.project.discrete_build': 'switch_model.generators.core.proj_discrete_build',
    'switch_model.project.dispatch': 'switch_model.generators.core.dispatch',
    'switch_model.project.no_commit': 'switch_model.generators.core.no_commit',
    'switch_model.project.unitcommit.commit': 'switch_model.generators.core.commit.operate',
    'switch_model.project.unitcommit.fuel_use': 'switch_model.generators.core.commit.fuel_use',
    'switch_model.project.unitcommit.discrete': 'switch_model.generators.core.commit.discrete',
    'switch_model.fuel_cost': 'switch_model.energy_sources.fuel_costs.simple',
    'switch_model.fuel_markets': 'switch_model.energy_sources.fuel_costs.markets',
    'switch_model.export': 'switch_model.reporting',
    'switch_model.local_td': 'switch_model.transmission.local_td',
    'switch_model.balancing_areas': 'switch_model.balancing.operating_reserves.areas',
    'switch_model.export.dump': 'switch_model.reporting.dump',
    'switch_model.generators.hydro_simple': 
...
def can_upgrade_inputs_dir(inputs_dir):
    ...
    Returns True/False
    """
    version = switch_model.upgrade.get_input_version(inputs_dir)
    if version is None:
        return False
...
def upgrade_input_dir(inputs_dir, verbose=False, backup=True):
    ...
    if backup:
        switch_model.upgrade._backup(inputs_dir)
    ...
    # If the original file didn't specify either switch_model or the list of
    # core modules, we need to insert switch_model.
    if not('switch_model' in module_list or
           'timescales' in module_list or
           'switch_model.timescales' in module_list):
        module_list.insert(0, 'switch_model')
    ...
    # remove duplicates (e.g., repeated expansion of switch_model)
