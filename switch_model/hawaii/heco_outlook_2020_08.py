...
# August 2020. There are near-term forecasts for 2021-2025 for all technologies and
...
def define_components(m):
    ...
    tech_group_targets_definite = [
        ...
        # NOTE: the HECO forecast for 2020 is below actual installed capacity
        ...
        # installations in 2019, 2020 and 2021. In "HECO construction plan 2020-03-17.docx"
        # they treat them all as being installed in 2020.
        # As of 8/7/2020, HECO website (https://www.hawaiianelectric.com/products-and-services/customer-renewable-programs/community-solar/cbre-phase-1)
        # says "Some projects for Phase 1 are still in development under the
        # original rules. Hawaiian Electric expects two Phase 1 CBRE projects to
        # go online in 2020 Q4. The unallocated capacity from Phase 1 has been
        # rolled over into Phase 2. No Phase 1 capacity is currently available."
        ...
        # status board
        # (https://www.hawaiianelectric.com/clean-energy-hawaii/our-clean-energy-portfolio/renewable-project-status-board,
        # 2020-02-27 - 2020-08-07) says they all come online in 2021. "HECO
        # construction plan 2020-03-17.docx" and HECO SOP 2 Exhibit P2
