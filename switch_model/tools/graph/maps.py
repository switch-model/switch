...
class GraphMapTools:
    ...
    def graph_pie_chart(self, df, bins=(0, 10, 30, 60, 1000), sizes=(200, 400, 600, 800), labels=("<10 GW", "10 to 30 GW", "30 to 60 GW", "60+ GW"), ax=None):
        """
        ...
        legend = ax.legend(
            ...
            handles=[
                self._tools.plt.lines.Line2D(
                    [], [], color=c, marker=".", markersize=10, label=l, linestyle="None"
                )
