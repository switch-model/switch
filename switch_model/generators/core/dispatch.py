...
def define_components(mod):
    ...
    scaling_factor_DispatchGen = 10**-2
    mod.ScaledDispatchGen = Var(mod.GEN_TPS, within=NonNegativeReals)
    mod.DispatchGen = Expression(
        mod.GEN_TPS,
        rule=lambda m, g, t: m.ScaledDispatchGen[g, t] / scaling_factor_DispatchGen,
    )
    ...
    mod.scaled_GenFuelUseRate = Var(mod.GEN_TP_FUELS, within=NonNegativeReals)
    mod.GenFuelUseRate = Expression(
        mod.GEN_TP_FUELS,
        rule=lambda m, g, t, f: m.scaled_GenFuelUseRate[g, t, f]
        / scaling_factor_GenFuelUseRate,
        doc=(
