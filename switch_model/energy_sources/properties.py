...
def load_inputs(mod, switch_data, inputs_dir):
    ...
    switch_data.load_aug(
        ...
        select=(
            ...
            "nox_intensity",
            "upstream_nox_intensity",
            "so2_intensity",
            "upstream_so2_intensity",
            "ch4_intensity",
            "upstream_ch4_intensity",
        ),
        index=mod.FUELS,
        param=(
            mod.f_co2_intensity,
            mod.f_upstream_co2_intensity,
            mod.f_nox_intensity,
            mod.f_upstream_nox_intensity,
            mod.f_so2_intensity,
            mod.f_upstream_so2_intensity,
            mod.f_ch4_intensity,
            mod.f_upstream_ch4_intensity,
        ),
    )
